...
def upgrade():
    ...
    if isinstance(c.connection.engine.dialect, PGDialect):
        ...
        if 'external_identities_local_user_name_fkey' in [c['name'] for c in insp.get_foreign_keys('external_identities')]:
            ...
            op.create_foreign_key(None, 'external_identities', 'users', remote_cols=['user_name'],
                                  local_cols=['local_user_name'], onupdate='CASCADE',
                                  ondelete='CASCADE')
        ...
        if 'groups_permissions_group_id_fkey' in [c['name'] for c in insp.get_foreign_keys('groups_permissions')]:
            ...
            op.create_foreign_key(None, 'groups_permissions', 'groups', remote_cols=['id'],
        ...
        if 'groups_resources_permissions_group_id_fkey' in [c['name'] for c in insp.get_foreign_keys('groups_resources_permissions')]:
            ...
            op.create_foreign_key(None, 'groups_resources_permissions', 'groups', remote_cols=['id'],
                                  local_cols=['group_id'], onupdate='CASCADE',
                                  ondelete='CASCADE')
        ...
        if 'groups_resources_permissions_resource_id_fkey' in [c['name'] for c in insp.get_foreign_keys('groups_resources_permissions')]:
            ...
            op.create_foreign_key(None, 'groups_resources_permissions', 'resources', remote_cols=['resource_id'],
                                  local_cols=['resource_id'], onupdate='CASCADE',
                                  ondelete='CASCADE')
        ...
        if 'resources_owner_group_id_fkey' in [c['name'] for c in insp.get_foreign_keys('resources')]:
            ...
            op.create_foreign_key(None, 'resources', 'groups', remote_cols=['id'],
                                  local_cols=['owner_group_id'], onupdate='CASCADE',
                                  ondelete='SET NULL')
        ...
        if 'resources_owner_user_id_fkey' in [c['name'] for c in insp.get_foreign_keys('resources')]:
            ...
            op.create_foreign_key(None, 'resources', 'users', remote_cols=['id'],
                                  local_cols=['owner_user_id'], onupdate='CASCADE',
                                  ondelete='SET NULL')
        ...
        if 'resources_parent_id_fkey' in [c['name'] for c in insp.get_foreign_keys('resources')]:
            ...
            op.create_foreign_key(None, 'resources', 'resources', remote_cols=['resource_id'],
        ...
        if 'users_groups_group_id_fkey' in [c['name'] for c in insp.get_foreign_keys('users_groups')]:
            ...
            op.create_foreign_key(None, 'users_groups', 'groups', remote_cols=['id'],
                                  local_cols=['group_id'], onupdate='CASCADE',
                                  ondelete='CASCADE')
        ...
        if 'users_groups_user_id_fkey' in [c['name'] for c in insp.get_foreign_keys('users_groups')]:
            ...
            op.create_foreign_key(None, 'users_groups', 'users', remote_cols=['id'],
        ...
        if 'users_permissions_user_id_fkey' in [c['name'] for c in insp.get_foreign_keys('users_permissions')]:
            ...
            op.create_foreign_key(None, 'users_permissions', 'users', remote_cols=['id'],
                                  local_cols=['user_id'], onupdate='CASCADE',
                                  ondelete='CASCADE')
        ...
        if 'users_resources_permissions_resource_id_fkey' in [c['name'] for c in insp.get_foreign_keys('users_resources_permissions')]:
            ...
            op.create_foreign_key(None, 'users_resources_permissions', 'resources', remote_cols=['resource_id'],
                                  local_cols=['resource_id'], onupdate='CASCADE',
                                  ondelete='CASCADE')
        ...
        if 'users_resources_permissions_user_id_fkey' in [c['name'] for c in insp.get_foreign_keys('users_resources_permissions')]:
            ...
            op.create_foreign_key(None, 'users_resources_permissions', 'users', remote_cols=['id'],
                                  local_cols=['user_id'], onupdate='CASCADE',
                                  ondelete='CASCADE')
