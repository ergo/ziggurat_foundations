...
class TestUser(BaseTestCase):
    ...
    def test_by_user_name_existing(self, db_session):
        ...
        queried_user = UserService.by_user_name('username',
    ...
    def test_by_user_name_not_existing(self, db_session):
        add_user(db_session)
        queried_user = UserService.by_user_name('not_existing_user',
                                                db_session=db_session)
    ...
    def test_by_user_names(self, db_session):
        ...
        queried_users = UserService.by_user_names(
            ['user1', 'user3'], db_session=db_session).all()
    ...
    def test_by_mail_and_username_none(self, db_session):
        found = UserService.by_email_and_username(
            'email', None, db_session=db_session)
        assert found is None
